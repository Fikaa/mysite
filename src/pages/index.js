            ...
            <Flex justifyContent={"center"} alignItems={"center"} h="100%">
              <Box mr="140px" w="520px">
                <Text
                  ...
                  lineHeight={"1.7em"}
                >
                  このサイトは全くプログラミングやったことない私がなにもわからないままぬま君に言われるがままにしただけでできたサイトです！なにもわからないけど見栄えが良くてモチベだけがでてきた！
                </Text>
              </Box>
              <Image
                src="https://plus.unsplash.com/premium_photo-1676654936496-67e5bc9e7235?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80"
                width={"640px"}
              />
            </Flex>
            <ScrollAnimation />
